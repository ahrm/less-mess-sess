...
sess_general_departments_xpath = '/html/body/form/table/tbody/tr[3]/td/table/\
tbody/tr[3]/td[6]/select/option[%d]'
...
if __name__ == '__main__':
    ...
    browser.find_by_xpath(
        sess_general_departments_xpath % departments[current_department]
    ).first.click()
    # select the term
    browser.find_by_xpath(sess_term_select_xpath).first.click()
    ...
    for i in range(1, len(elems)):  # 10 -> len(elems)
        ...
        try:
            ...
            prof_name_match = re.match(
                pyregex.professor_name_re, teacher_string)
